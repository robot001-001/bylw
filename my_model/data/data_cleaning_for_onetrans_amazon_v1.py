...
TASKS = [
    {
        'input': 'tmp/amzn_books/sasrec_format_binary_augment_v1.csv',
        'output': 'tmp/amzn_books/sasrec_format_binary_augment_onetrans_v1.csv'
    },
    {
        'input': 'tmp/amzn_books/sasrec_format_binary_v1.csv',
        'output': 'tmp/amzn_books/sasrec_format_binary_onetrans_testset_v1.csv'
    }
]
# =======================================
