...
# 1. 加载数据
data_home = 'tmp/amzn_books/sasrec_format_binary_augment.csv'
...
data.to_csv('tmp/amzn_books/sasrec_format_binary_augment_onetrans.csv', index=False)


# 1. 加载数据
data_home = 'tmp/amzn_books/sasrec_format_binary.csv'
data = pd.read_csv(data_home)
...
data.to_csv('tmp/amzn_books/sasrec_format_binary_onetrans_testset.csv', index=False)