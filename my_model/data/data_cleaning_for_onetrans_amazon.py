...
TASKS = [
    {
        'input': 'tmp/amzn_books/sasrec_format_binary_augment.csv',
        'output': 'tmp/amzn_books/sasrec_format_binary_augment_onetrans.csv'
    },
    {
        'input': 'tmp/amzn_books/sasrec_format_binary.csv',
        'output': 'tmp/amzn_books/sasrec_format_binary_onetrans_testset.csv'
    }
]
# =======================================
